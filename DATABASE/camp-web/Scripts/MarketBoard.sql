...
VALUES(SEQ_MARKET_BOARD.NEXTVAL, '가즈아~', '으디를 가~! !!!', 'test1', SYSDATE
);
...
INSERT INTO TBL_MARKET_REPLY (RNO, BNO, REPLY, REPLYER) VALUES (SEQ_MARKET_REPLY.NEXTVAL, 1, '별로인데용?!', '프로댓글러');
