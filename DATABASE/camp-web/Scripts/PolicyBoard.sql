...
ALTER TABLE TBL_POLICY_BOARD MODIFY (CONTENT VARCHAR2(4000));
...
(BNO, TITLE, CONTENT, WRITER, REGDATE, TAB)
VALUES(SEQ_POLICY_BOARD.NEXTVAL, '가즈아~', '으디를 가~! !!!', 'test1', SYSDATE, 'notices'
);
INSERT INTO TBL_POLICY_BOARD
(BNO, TITLE, CONTENT, WRITER, REGDATE, TAB)
VALUES(SEQ_POLICY_BOARD.NEXTVAL, '권리침해~', '으디를 가~! !!!', 'test1', SYSDATE, 'safeguard'
);

SELECT * FROM TBL_POLICY_BOARD ORDER BY BNO desc;
SELECT * FROM TBL_MARKET_BOARD tmb;
