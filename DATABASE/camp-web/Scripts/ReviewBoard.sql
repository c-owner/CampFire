...
OR TITLE LIKE '%마지막이다%' 
OR CONTENT LIKE '%마지막이다%' 
OR WRITER LIKE '%마지막이다%' 
OR ADDRESS LIKE '%마지막이다%' 
OR ADDRESS_DETAIL LIKE '%마지막이다%' 
OR ADDRESS_ETC LIKE '%마지막이다%' 
OR CAMPNAME LIKE '%마지막이다%'
...
*/ ROWNUM rn, BNO, TITLE, CONTENT, WRITER, REGDATE, UPDATEDATE, LIKECNT, READCNT, REPLYCNT, 
