...
VALUES(SEQ_FREE_BOARD.NEXTVAL, '가즈아~', '으디를 가~! !!!', '가즈아!', SYSDATE
);
...
INSERT INTO TBL_FREE_REPLY (RNO, BNO, REPLY, REPLYER) VALUES (SEQ_FREE_REPLY.NEXTVAL, 1, '별로인데용?!', '프로댓글러');
...
ALTER TABLE TBL_FREE_ATTACH ADD CONSTRAINT FK_FREE_BOARD_ATTACH FOREIGN KEY(BNO) REFERENCES TBL_FREE_BOARD(BNO);
