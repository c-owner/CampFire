...
## 2021-06-18 ♻️v0.01i-alpha

- 리뷰 페이지 수정 버튼 수정 
- 리뷰 페이지 댓글 1글자 이상 가능 
- 댓글 글자수 최대 300자 축소 
- 수정일 24시간 형식
  - 자유게시판 / 팁게시판 / 음식 게시판 / 가이드 게시판 / 

- 로그아웃시 어드민 권한 삭제

==> 테스트 이상 없음 

- 로그인하고 나면 모바일에서 메뉴 로그아웃 버튼 활성화 처리
- 모든 게시판 데이터 삭제 -
- 공지사항 페이지 탭 메뉴 스타일 조정 
- 마켓 페이지 스타일 수정 (게시글 1개일 때 썸네일 깨짐)
- 고객센터 및 footer.jsp 서비스 관련 링크 -> policy 링크 통합 
- 

---

## 2021-06-16 ♻️ v0.01h-alpha
...
- page
  - home.jsp 메뉴 경로 수정..(header와 동일하게 지정했습니다..)
  - footer.jsp 경로 fix
  - policy 페이지 스타일 조정 
- web.xml, 컨트롤러 및 task 경로 fix.. 서버 로컬 경로로 맞추었습니다..

- 리뷰페이지 
  - 검색 키워드 null 일 경우 전체 조회 
  - 리뷰페이지 카테고리 메뉴 높이 균형 스타일 조정
  - XML 수정
...
- 공지사항 뷰 구현 
  - 컨트롤러 구현 중
- SERVER LOCAL PATH 경로 BUG FIX ( 파일 첨부 / 삭제 관련 )
- header / home 각 페이지 경로 재수정 
- 자유게시판 디테일 스타일 수정
