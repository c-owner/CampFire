...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/resources/assets/css/layout.css'/>">
    <link rel="stylesheet" href="<c:url value='/resources/assets/css/main-full.css'/>">
    <link rel="shortcut icon" type="image/x-icon" href="<c:url value='/resources/images/title-icon.png'/>">
