			...
			<section class="main special" style="margin-top: 30px;">
				...
				<div class="row" style="display:block;">
					...
					<div class="col-6 col-10-medium col-11-small" style="margin: 0 auto; text-align: right;">
						<a class="button small" id="boardReport" href="/free/freeModify${cri.getListLink()}&bno=${board.bno}" style="box-shadow: 0 0 0 0.5px black"><i class="far fa-lightbulb"></i>&nbsp;신고</a>
