					...
					<div class="header">
						<div class="row">
							...
							<div class="col-6" style="text-align:right;">
								<div class="row">
									<span style="margin-left: auto;">작성일 : ${food.updateDate}</span>
								</div>
								<div class="row">
									<span style="margin-left: auto;">조회수 : ${food.readCnt}</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-6 col-10-medium col-11-small" style="margin: 0 auto 10px auto;">
					<div class="row">
						<div class="col-3" style="text-align:left; text-decoration: none;">
							...
							<span id="likeCount">${food.likeCnt}</span>
							</a>
						</div>
...
<jsp:include page="../includes/footer.jsp"/>
	...
	<script src="/resources/assets/js/campfire/foodReply.js"></script>
	<script>
		...
		$(document).ready(function () {
			$("#heartIcon").on("click", function(e){
				...
				if(heart.hasClass("far")){ //하트아닐때
					$.ajax({
						type: "get",
						url: contextPath + "/campfire/plusLike/"+bno+"/"+sessionId,
					...
					$.ajax({
						type: "get",
						url: contextPath + "/campfire/minusLike/"+bno+"/"+sessionId,
						contentType:"application/text; charset=utf-8",
						success: function(result){
			...
			function getCount(bno){
				$.ajax({
					type: "get",
					url: contextPath + "/campfire/getLikeCnt/"+bno,
					contentType:"application/text; charset=utf-8",
					success: function(result){
