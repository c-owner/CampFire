...
public class FreeBoardReplyController {
	...
	//댓글 등록
	@PostMapping(value="/freeReplyWrite", consumes="application/json", produces="text/html; charset=utf-8")
	public ResponseEntity<String> register(@RequestBody FreeBoardReplyVO f_vo){
	...
	public ResponseEntity<String> modify(@PathVariable("rno") Long rno, @RequestBody FreeBoardReplyVO f_vo){
		f_vo.setRno(rno);
