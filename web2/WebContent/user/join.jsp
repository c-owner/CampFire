...
<p></p>
<form name="joinForm" method="post" action="${pageContext.request.contextPath}/user/UserJoin.me">
    <div class="row gtr-uniform">
        <div class="col-6 col-12-xsmall" style="margin: 0 auto;">
            ...
            <input type="text" name="userId" id="userId" placeholder="ex)abc123 / abcd" minlength="4"
                   maxlength="12"/>
            <br>
            <p id="idCheck_text"></p>
            <br>
            ...
            <div class="col-6 col-12-small">
                <input type="checkbox" id="email-push" name="emailPush" onclick="checkOnlyOne(this)">
                [선택]
                <label for="email-push">수신거부</label>
                <input type="checkbox" id="email-push2" name="emailPush" onclick="checkOnlyOne(this)" checked>
